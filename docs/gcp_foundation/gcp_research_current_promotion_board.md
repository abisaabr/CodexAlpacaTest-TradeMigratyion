...
- State: `phase32b_phase37_running_phase36_completed`
- Broker-facing: `false`
- Live manifest effect: `none`
- Risk policy effect: `none`
- Active Batch jobs: `phase32b-unexplored-top100-tranche2-20260428122500` (`RUNNING`, 14 succeeded / 1 running at last check) and `phase37-top10-atm-20260428183723` (`RUNNING`, 2 succeeded / 5 running / 3 pending at last check). Phase36 completed with 15 succeeded shards and is awaiting aggregation.
...
- Research: monitor Phase32b, Phase36, and Phase37 to completion; build portfolio-level aggregation from completed packets, then adapt the dense single-symbol QQQ downloader pattern for liquid names where sparse selected-contract data is blocking otherwise promising candidates.
