...
- Active Batch jobs: `phase32b-unexplored-top100-tranche2-20260428122500` (`RUNNING`, 11 succeeded / 3 running / 1 pending at last check), `phase36-core-liq-20260428180637` (`RUNNING`, 5 succeeded / 4 running / 6 pending at last check), and `phase37-top10-atm-20260428183723` (`SCHEDULED`, 6 pending at last check)
...
- Interim scan across 32 completed output packets has `0` new governed-validation candidates. The dominant blocker remains `fill_coverage_below_0.90`; the newly scanned Phase36 liquid names are also research-only blocked.
