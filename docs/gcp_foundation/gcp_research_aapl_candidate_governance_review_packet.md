...
- `pending_phase27_adversarial_cost_and_lag_stress`
- `not_approved_for_live_manifest_or_risk_policy_change`

## Phase27 Confirmation

Phase27 is the next non-broker-facing confirmation step:
...
- Phase27 adversarial stress result.
...
Default to `hold` unless Phase27 remains clean and a later sanctioned VM paper session produces clean broker-audited evidence. Do not modify live manifests, live strategy selection, or risk policy from this packet alone.
