...
- Generated at: `2026-04-22T15:54:35.528049`
...
- `wire_profile_entrypoint`: Wire this profile into an executable governed entrypoint and launch path before trying to activate it. Affects `3` profiles.
