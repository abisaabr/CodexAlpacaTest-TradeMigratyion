...
- Generated at: `2026-04-22T15:13:46.144751`
...
- `wire_profile_entrypoint`: Wire this profile into an executable governed entrypoint and launch path before trying to activate it. Affects `4` profiles.
...
- `opening_30m_premium_defense`: state `implementation_and_policy_blocked`, unmet `4`, blockers `implementation_not_wired, execution_evidence_floor, broker_order_audit_coverage, broker_activity_audit_coverage`, next objectives `wire_profile_entrypoint, upgrade_execution_evidence_to_entry_and_reconciliation, land_trusted_broker_order_audit_sessions, land_trusted_broker_activity_audit_sessions`
- `balanced_family_expansion_benchmark`: state `implementation_and_policy_blocked`, unmet `4`, blockers `implementation_not_wired, execution_evidence_floor, broker_order_audit_coverage, broker_activity_audit_coverage`, next objectives `wire_profile_entrypoint, upgrade_execution_evidence_to_entry_and_reconciliation, land_trusted_broker_order_audit_sessions, land_trusted_broker_activity_audit_sessions`
...
- Blockers: `implementation_not_wired, execution_evidence_floor, broker_order_audit_coverage, broker_activity_audit_coverage`
- Next unlock objectives: `wire_profile_entrypoint, upgrade_execution_evidence_to_entry_and_reconciliation, land_trusted_broker_order_audit_sessions, land_trusted_broker_activity_audit_sessions`
...
- Preferred machine now: `current_research_machine`
- Preferred machine target: `new_machine`
- Blockers: `implementation_not_wired, execution_evidence_floor, risk_tier_cap, broker_order_audit_coverage, broker_activity_audit_coverage, exit_telemetry`
- Next unlock objectives: `wire_profile_entrypoint, upgrade_execution_evidence_to_broad, raise_execution_risk_ceiling_to_aggressive, land_trusted_broker_order_audit_sessions, land_trusted_broker_activity_audit_sessions, land_reliable_exit_telemetry`
