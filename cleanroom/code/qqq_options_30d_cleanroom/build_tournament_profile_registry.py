...
TOURNAMENT_PROFILES: list[dict[str, Any]] = [
    {
        ...
        "maximum_latest_unlock_session_age_days": 0,
    ...
    },
    {
        ...
        "maximum_latest_unlock_session_age_days": 5,
    ...
    },
    {
        ...
        "maximum_latest_unlock_session_age_days": 7,
        "requires_broker_order_audit_coverage": True,
        "requires_broker_activity_audit_coverage": True,
        "requires_exit_telemetry": False,
        "preferred_machine_now": "current_research_machine",
    ...
    },
    {
        ...
        "execution_window": "all_day",
        "entrypoint": "launch_nightly_operator_cycle.ps1",
        "underlying_program": "launch_balanced_family_expansion_program.ps1",
        "discovery_source": "coverage_ranked",
        "bootstrap_ready_universe": True,
