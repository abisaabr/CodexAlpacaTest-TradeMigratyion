...
FALLBACK_OPERATING_MODEL: dict[str, Any] = {
    "agents": [
        ...
        {
            "agent": "Execution Calibration Steward",
            "lane_type": "control_plane",
            "parallelism": 1,
            "writes_live_state": False,
            "scripts": ["build_execution_calibration_registry.py", "build_execution_calibration_handoff.py"],
            "inputs": ["paper-runner reports", "reconciliation events", "session state"],
            "outputs": ["execution_calibration_registry.json", "execution_calibration_handoff.json"],
            "success_gate": "Execution evidence and posture are refreshed before major research profile or scoring decisions.",
            "handoff_to": ["Strategy Family Steward", "Reporting Steward"],
...
ROLE_OVERRIDES: dict[str, dict[str, Any]] = {
    ...
    "Execution Calibration Steward": {
        "plane": "control",
        "split_axis": "execution_feedback",
        "automation_level": "autonomous",
        "approval_level": "packet_only",
        "preferred_machine_now": "either_machine",
        ...
        "prohibited_actions": [
            "write_live_manifest",
            "approve_production_changes",
            "override_execution_evidence_without_packet",
        ],
    },
    "Data Prep Steward": {
        "plane": "research",
